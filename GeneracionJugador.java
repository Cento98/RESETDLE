...
public class GeneracionJugador {
	...
	private Jugador generarJugador() {
		...
		this.jugadores.add(new Jugador("Snyk","Horda",new String[]{"Hunter"},new String[]{"Druida","Brujo"},"No",new String[]{"Dps"},"1993"));
        ...
        this.jugadores.add(new Jugador("Xeraxy","Alianza",new String[]{"Sacerdote",},new String[]{"Druida", "DK"},"Si",new String[]{"Heal","Dps"},"1999"));
        ...
        this.jugadores.add(new Jugador("Dragonlillo","Horda",new String[]{"Evoker"},new String[]{"Monje"},"No",new String[]{"Dps"},"2000"));
        this.jugadores.add(new Jugador("Trendelacaca","Horda",new String[]{"Druida",},new String[]{"Chaman"},"Si",new String[]{"Heal, Dps"},"2001"));
        this.jugadores.add(new Jugador("Jude","Alianza",new String[]{"Monje"},new String[]{"Chaman", "Druida"},"No",new String[]{"Tank, Dps"},"1998"));
        ...
        this.jugadores.add(new Jugador("Akaeva","Alianza",new String[]{"Druida"},new String[]{"Evoker"},"No",new String[]{"Heal"},"1991"));
        this.jugadores.add(new Jugador("Gato","Alianza",new String[]{"Mago"},new String[]{"DK"},"No",new String[]{"Dps"},"1998"));
